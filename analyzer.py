...
if count_names:
    ...
    # names = ["aleksei", "anton", "ashish", "asla", "bianca", "emily", "erika", "gurveer", "hanin", "helena", "iiris", "ina", "isioma", "joel", "kowsar", "kriti", "matias", "medini", "miko", "noa", "oliver", "raj", "ronia", "sofia", "vera"]
